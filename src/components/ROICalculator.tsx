      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <TextAnimate className="text-xl text-muted-foreground max-w-3xl mx-auto" duration={1} delay={1} by="character" as="p">
              See exactly how much revenue you&apos;re missing from calls that
              go unanswered. Most contractors are shocked by the numbers.
            </TextAnimate>
          </div>
                    ...
                    <div className="space-y-6">
                      <div className="bg-destructive/10 p-4 rounded-lg">
                        ...
                        <div className="space-y-2">
                          ...
                          <p className="text-lg font-bold text-destructive">
                            Yearly: ${results.yearly.toLocaleString()}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="bg-success/10 p-4 rounded-lg">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Our AI captures and converts missed calls 24/7,
                          helping you recover up to 80% of this lost revenue.
                        </p>
                      </div>
